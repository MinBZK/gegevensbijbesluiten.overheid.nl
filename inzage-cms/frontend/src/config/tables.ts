...
const tables: Array<Table> = [
  ...
  },
  {
    ...
    resource: 'oe-koepel',
    nameKey: 'titel',
    primaryKey: 'oe_koepel_cd',
    maxWidthDialog: 1160,
    columns: {
      oe_koepel_cd: 'Code oe koepel',
      titel: 'Naam koepelorganisatie',
  ...
  },
  {
    ...
    nameKey: '',
    primaryKey: 'oe_koepel_oe_cd',
    maxWidthDialog: 1160,
    columns: {
      oe_koepel_oe_cd: 'Code koppeling oe koepel',
      oe_koepel_cd: 'Koepel organisatie',
      oe_cd: 'Organisatie',
      notitie: 'Notitieveld',
      user_nm: 'ID Redacteur',
      ts_mut: 'Tijdstip laatste mutatie',
