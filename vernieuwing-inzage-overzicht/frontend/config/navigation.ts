...
export const navigationHeaders: navigationHeader[] = [
  {
    ...
    pageDescriptionParagraph_1: 'homePageText.description_1',
    pageDescriptionParagraph_2: 'homePageText.description_2_1',
    pageDescriptionParagraph_2_2: 'homePageText.description_2_2',
