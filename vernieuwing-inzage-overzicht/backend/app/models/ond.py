...
class EvtpOnd(Base):
    """
    Besluiten-onderwerpen
    TabelLabelLang: De koppeling tussen besluiten en onderwerpen
    Comment: Cross-reference tusen besluiten en onderwerpen
    """

    __tablename__ = "evtp_ond"

    evtp_ond_cd: Mapped[int] = mapped_column(Integer, primary_key=True)
    ond_cd: Mapped[int] = mapped_column(
        Integer,
        ForeignKey("ond.ond_cd"),
    )
